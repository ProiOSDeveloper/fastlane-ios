...
fastspec_path = '../fastspec'
provisioning_path = "../../provisioning"

# TestFlight
lane :punchh_testflight do
...
lane :provisioning do
  cert(development: true, output_path: provisioning_path)
  cert(output_path: archive_path)
  sigh(development: true, output_path: provisioning_path)
  sigh(adhoc: true, output_path: provisioning_path, force: true)
  sigh(output_path: provisioning_path, force: true)
end
